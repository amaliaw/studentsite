			...
			<div class="col-md-12">
				<div class="card mt-5">
					<div class="card-header">
						<div class="i fa fa-plus"></div> Tambah Data Santri
					</div>
					<div class="card-body">
						<form action="<?php echo base_url('admin/add-new-data-list-santri') ?>" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<select name="pendidikan" class="form-control" id="pendidikan" value="<?= set_value('pendidikan') ?>">
									<option value="">-- PILIH --</option>
									<option>SD/MI</option>
							...
							<div class="form-inline my-1">
								...
								<input required type="text" class="form-control" id="anak_ke" name="anak_ke" value="<?= set_value('anak_ke') ?>" style="width: 50px">
								<?php echo form_error('anak_ke', '<small class="text-danger">', '</small>'); ?>
								<label for="dari">&nbsp;dari &nbsp;</label>
								<input required type="text" class="form-control" id="dari" name="dari" style="width: 50px" value="<?= set_value('dari') ?>">
